...
namespace TrailDLL
{
    public sealed class TrailSimpleRibbon : TrailSimple
	{
        public TrailSimpleRibbon(Game hGame, int iLength, float fRadius, Color vStartColor, Color vEndColor, BlendState vBlend, bool bShrink, Texture2D hTexture, float fTextureRepeat, SamplerState hSamplerState)
            : base(hGame, iLength, fRadius, vStartColor, vEndColor, vBlend, bShrink, hTexture, fTextureRepeat, hSamplerState)
        {
        }

        /// <summary>
        /// Calculate shrinking and color, updates VertexData with 3D positions given by the
        /// segments.
        /// </summary>
